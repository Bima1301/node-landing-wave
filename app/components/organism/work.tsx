...
export default function Work() {
    ...
    return (
        <motion.section ref={targetRef} className='md:mb-28 mb-20 relative px-[4rem]' initial={{ opacity: 0, y: 100 }}
            ...
            <div className='lg:flex hidden flex-col items-center overflow-hidden'>
                <motion.div className='flex gap-8 px-10' style={{ x }}>
                    <Card className='flex flex-row gap-5 px-5 py-20 text-white relative min-w-[48rem] overflow-hidden'>
