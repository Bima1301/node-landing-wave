...
export default function Produk() {
    return (
        <motion.section className='xl:px-[12rem] lg:px-[8rem] px-10 md:mb-28 mb-20' initial={{ opacity: 0, y: 100 }}
            ...
            <Title title="Our Produk" className="text-center text-white md:mt-10 mb-14" />
            <div className='flex lg:flex-row flex-col-reverse gap-5'>
                <div className='flex flex-col gap-5 justify-between'>
                    <Card className='bg-white md:px-10 px-3 md:py-12 py-4 text-black flex flex-row items-end gap-3'>
                    ...
                    <Card className='bg-black md:px-10 px-3 md:py-12 py-4 text-white flex flex-row items-end gap-3 lg:mx-5'>
