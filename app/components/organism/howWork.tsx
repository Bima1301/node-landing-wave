        ...
        <motion.section className='xl:px-[12rem] lg:px-[8rem] px-10 md:mb-28 mb-20 relative pb-12' initial={{ opacity: 0, y: 100 }}
            ...
            <div className='z-10 relative flex justify-center items-center flex-col h-fit 14'>
                ...
                <div className='bg-[url(/images/howWorkContent.jpeg)] flex md:flex-row flex-col-reverse md:items-start items-center p-5 rounded-lg md:max-w-[773px] max-w-full'>
                    <div className='flex flex-col gap-4 bg-white px-4 pt-8 pb-28  rounded-lg max-w-[300px]'>
                        {conversations.map((item, index) => (
                            <div className={`flex  ${index % 2 == 0 ? "flex-row" : "flex-row-reverse"} gap-6 text-black items-start`} key={index}>
                    ...
                    <div className='flex flex-col px-10 md:mt-9 my-5'>
                        <p className='text-xl font-semibold mb-5 md:text-start text-center'>Estimate</p>
